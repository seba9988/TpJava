...
<%@ include file="/Include/Head.html" %>
    ...
    <form action="ArbitroServlet" method=post>
        <div class="row mt-3">
          ...
          <div class="col-sm-8">
            <input type="text" name="nombre" class="form-control" Value="<%=a.getNombre()%>" required>
          </div>
        </div>
        <div class="row mt-3">
            <label for="apellido" class="col-form-label col-sm-2">Apellido Arbitro: </label>
            <div class="col-sm-8">
              <input type="text" name="apellido" class="form-control" Value="<%=a.getApellido()%>" required>
            </div>
          </div>
        <div class="row mt-3">
          <label for="fechaNac" class="col-form-label col-sm-2">Fecha Nacimiento: </label>
          <div class="col-sm-8">
            <input type="date" name="fechaNac" class="form-control" Value="<%=a.getFecha_nacimiento()%>" required>
          </div>
        </div>
